...
abstract class BaseStflFlow extends CActiveRecord{
	...
	{
		return array(
			'stfl_id' => Yii::t('D1StatusModule.crud', 'Stfl'),
			'stfl_name' => Yii::t('D1StatusModule.crud', 'Stfl Name'),
			'stfl_table' => Yii::t('D1StatusModule.crud', 'Stfl Table'),
			'stfl_field' => Yii::t('D1StatusModule.crud', 'Stfl Field'),
			'stfl_notes' => Yii::t('D1StatusModule.crud', 'Stfl Notes'),
		);
	}
