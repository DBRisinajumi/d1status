...
abstract class BaseStsfStatesFlow extends CActiveRecord{
	...
	{
		return array(
			'stsf_id' => Yii::t('D1StatusModule.crud', 'Stsf'),
			'stsf_stfl_id' => Yii::t('D1StatusModule.crud', 'Stsf Stfl'),
			'stsf_prev_stst_id' => Yii::t('D1StatusModule.crud', 'Stsf Prev Stst'),
			'stsf_next_stst_id' => Yii::t('D1StatusModule.crud', 'Stsf Next Stst'),
			'stsf_notes' => Yii::t('D1StatusModule.crud', 'Stsf Notes'),
		);
	}
