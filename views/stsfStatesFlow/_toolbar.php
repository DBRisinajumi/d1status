<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('D1StatusModule.crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'stfaFlowAccesses - StfaFlowAccess', 'url' =>array('stfaFlowAccess/admin')),array('label'=>'stsfStfl - StflFlow', 'url' =>array('stflFlow/admin')),array('label'=>'stsfPrevStst - StstState', 'url' =>array('ststState/admin')),array('label'=>'stsfNextStst - StstState', 'url' =>array('ststState/admin')),
            )
          ),
        ),
    ));
