<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'stlgUser - SUsers', 'url' =>array('sUsers/admin')),array('label'=>'stlgStfl - StflFlow', 'url' =>array('stflFlow/admin')),array('label'=>'stlgStst - StstState', 'url' =>array('ststState/admin')),
            )
          ),
        ),
    ));
