 ...
 <div class="row">
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stlg_record_id' != $help = Yii::t('crud', 'help.stlg_record_id')) { 
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stlg_datetime' != $help = Yii::t('crud', 'help.stlg_datetime')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
        <label for="stlgUser"><?php echo Yii::t('crud', 'StlgUser'); ?></label>
                <?php
                $this->widget(
					'Relation',
					array(
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
        <label for="stlgStfl"><?php echo Yii::t('crud', 'StlgStfl'); ?></label>
                <?php
                $this->widget(
					'Relation',
					array(
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
        <label for="stlgStst"><?php echo Yii::t('crud', 'StlgStst'); ?></label>
                <?php
                $this->widget(
					'Relation',
					array(
