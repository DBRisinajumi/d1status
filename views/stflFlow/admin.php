<?php
$this->breadcrumbs[] = Yii::t('D1StatusModule.crud','Stfl Flows');
...
<h1>
    <?php echo Yii::t('D1StatusModule.crud', 'Stfl Flows'); ?> <small><?php echo Yii::t('D1StatusModule.crud', 'Manage'); ?></small>
</h1>
