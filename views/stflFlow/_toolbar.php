<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('D1StatusModule.crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'stlgLogs - StlgLog', 'url' =>array('stlgLog/admin')),array('label'=>'stsfStatesFlows - StsfStatesFlow', 'url' =>array('stsfStatesFlow/admin')),
            )
          ),
        ),
    ));
