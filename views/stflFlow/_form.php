 ...
 <div class="row">
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stfl_name' != $help = Yii::t('crud', 'help.stfl_name')) { 
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stfl_table' != $help = Yii::t('crud', 'help.stfl_table')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stfl_field' != $help = Yii::t('crud', 'help.stfl_field')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stfl_notes' != $help = Yii::t('crud', 'help.stfl_notes')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
