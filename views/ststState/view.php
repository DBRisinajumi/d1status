...
<div class='span3'><?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
        ...
        'buttons'=>array(
            array('label'=>'stsfStatesFlows', 'icon'=>'icon-list-alt', 'url'=> array('stsfStatesFlow/admin')),
                array('icon'=>'icon-plus', 'url'=>array('stsfStatesFlow/create', 'StsfStatesFlow' => array('stsf_prev_stst_id'=>$model->{$model->tableSchema->primaryKey}))),
        ),
    )); ?></div><div class='span8'>
<?php
    echo '<span class=label>CHasManyRelation</span>';
...
<div class='span3'><?php $this->widget('bootstrap.widgets.TbButtonGroup', array(
        ...
        'buttons'=>array(
            array('label'=>'stsfStatesFlows1', 'icon'=>'icon-list-alt', 'url'=> array('stsfStatesFlow/admin')),
                array('icon'=>'icon-plus', 'url'=>array('stsfStatesFlow/create', 'StsfStatesFlow' => array('stsf_next_stst_id'=>$model->{$model->tableSchema->primaryKey}))),
        ),
    )); ?></div><div class='span8'>
<?php
    echo '<span class=label>CHasManyRelation</span>';
