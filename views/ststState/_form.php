 ...
 <div class="row">
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stst_name' != $help = Yii::t('crud', 'help.stst_name')) { 
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stst_code' != $help = Yii::t('crud', 'help.stst_code')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
    ...
    <div class="row-fluid input-block-level-container">
        <div class="span12">
            ...
            <?php if('help.stst_icon' != $help = Yii::t('crud', 'help.stst_icon')) { 
                echo "<span class='help-block'>{$help}</span>";            
} ?>
        </div>
    </div>
