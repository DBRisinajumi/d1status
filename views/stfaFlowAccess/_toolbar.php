<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'stfaAuthitem - Authitem', 'url' =>array('authitem/admin')),array('label'=>'stfaStsf - StsfStatesFlow', 'url' =>array('stsfStatesFlow/admin')),
            )
          ),
        ),
    ));
