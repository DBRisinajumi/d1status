<div class="btn-toolbar">
    ...
    $this->widget("bootstrap.widgets.TbButton", array(
        ...
        'buttons'=>array(
                array('label'=>Yii::t('D1StatusModule.crud','Relations'), 'icon'=>'icon-search', 'items'=>array(array('label'=>'stfaStsf - StsfStatesFlow', 'url' =>array('stsfStatesFlow/admin')),array('label'=>'stfaAuthitem - Authitem', 'url' =>array('authitem/admin')),
            )
          ),
        ),
    ));
